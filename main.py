...
opt = PranamOptimizer(sess=sess,func=nonconvex_net, num_clones=50,optimizer=tf.train.GradientDescentOptimizer,
                      func_pars=[2], embed_vars=None, batch_size=2,
                      embedder_pars=[[None,50,None]], learning_rate=1e-5)
